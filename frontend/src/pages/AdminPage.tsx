...
import {
  Pizza, RefreshCw, ClipboardList, FolderOpen,
  Star, StarOff, Pencil, Trash2, ArrowRight, Plus,
} from 'lucide-react';
import type { Pizza as PizzaType, Category, Order } from '../types';
...
export function AdminPage() {
  ...
  const [editPizza, setEditPizza] = useState<PizzaType | null>(null);
  ...
  const handleToggle = async (pizza: PizzaType, field: 'isAvailable' | 'isHit') => {
    ...
    <div className={styles.page}>
      <header className={styles.header}>
        <div className={styles.headerLeft}>
          <span className={styles.logo}><Pizza size={28} /></span>
          <div>
              ...
              <div key={pizza.id} className={styles.card}>
                ...
                <div className={styles.cardBody}>
                  ...
                  <div className={styles.cardActions}>
                    ...
                    >
                      {pizza.isHit ? <Star size={18} fill="currentColor" /> : <StarOff size={18} />}
                    </button>
                    <button
              ...
              <div className={styles.orderFooter}>
                ...
                <div className={styles.orderActions}>
                  {nextStatus[order.status] && (
                    ...
                    >
                      <ArrowRight size={16} /> {statusLabels[nextStatus[order.status]]}
                    </button>
                  )}
                  <button
          ...
          {categories.map((cat) => (
            <div key={cat.id} className={styles.categoryCard}>
              <div className={styles.categoryInfo}>
                <span className={styles.categoryIcon}>{cat.icon || <FolderOpen size={18} />}</span>
